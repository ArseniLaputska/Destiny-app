...
//  Destini-iOS13
//
//  Created by Arseni Laputska on 19/08/2020.
...
struct StoryBrain {
    ...
    func getChoicesText1() -> String {
        return stories[storiesNumber].choice1
       }
    func getChoicesText2() -> String {
     return stories[storiesNumber].choice2
    }
    
    mutating func nextStory(userChoice: String) {

    let currentStory = stories[storiesNumber]

    if userChoice == currentStory.choice1 {
        storiesNumber = currentStory.choice1Destination
    } else if userChoice == currentStory.choice2 {
        storiesNumber = currentStory.choice2Destination
    }
    }
}
